...
class TestNeuralNetwork(unittest.TestCase):
    ...
    def test_affine(self):
        with open('tests/check_affine.txt', 'r') as f:
            ...
            test_Z, cache = nn.affine_forward(A, W, b)
            test_dA, test_dW, test_db = nn.affine_backward(dZ, cache)
    ...
    def test_relu(self):
        with open('tests/check_relu.txt', 'r') as f:
            ...
            test_A, cache = nn.relu_forward(Z)
            test_dZ = nn.relu_backward(dA, cache)
    ...
    def test_crossentropy(self):
        with open('tests/check_cross_entropy.txt', 'r') as f:
            ...
            test_loss, test_dF = nn.cross_entropy(F, y)
    ...
    def test_minibatch_gradient(self):
        ...
        w1, w2, w3, w4, b1, b2, b3, b4, losses = nn.minibatch_gd(10, w1, w2, w3, w4, b1, b2, b3, b4, x_train, y_train, 3, False)
